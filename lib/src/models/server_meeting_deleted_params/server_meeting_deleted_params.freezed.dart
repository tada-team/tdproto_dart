...
/// @nodoc
abstract class _$ServerMeetingDeletedParamsCopyWith<$Res>
    implements $ServerMeetingDeletedParamsCopyWith<$Res> {
  factory _$ServerMeetingDeletedParamsCopyWith(
          _ServerMeetingDeletedParams value,
          $Res Function(_ServerMeetingDeletedParams) then) =
...
/// @nodoc
class __$ServerMeetingDeletedParamsCopyWithImpl<$Res>
    extends _$ServerMeetingDeletedParamsCopyWithImpl<$Res>
    implements _$ServerMeetingDeletedParamsCopyWith<$Res> {
  __$ServerMeetingDeletedParamsCopyWithImpl(_ServerMeetingDeletedParams _value,
      $Res Function(_ServerMeetingDeletedParams) _then)
      : super(_value, (v) => _then(v as _ServerMeetingDeletedParams));

  @override
  _ServerMeetingDeletedParams get _value =>
      super._value as _ServerMeetingDeletedParams;
...
class _$_ServerMeetingDeletedParams implements _ServerMeetingDeletedParams {
  const _$_ServerMeetingDeletedParams(
      {@JsonKey(name: 'meeting_id') required this.meetingIds});
        ...
        (other is _ServerMeetingDeletedParams &&
            (identical(other.meetingIds, meetingIds) ||
                const DeepCollectionEquality()
                    .equals(other.meetingIds, meetingIds)));
  }

  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(meetingIds);

  @JsonKey(ignore: true)
  @override
  _$ServerMeetingDeletedParamsCopyWith<_ServerMeetingDeletedParams>
      get copyWith => __$ServerMeetingDeletedParamsCopyWithImpl<
          _ServerMeetingDeletedParams>(this, _$identity);
