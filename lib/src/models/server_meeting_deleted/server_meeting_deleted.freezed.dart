...
mixin _$ServerMeetingDeleted {
  ...
  @JsonKey(ignore: true)
  $ServerMeetingDeletedCopyWith<ServerMeetingDeleted> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ServerMeetingDeletedCopyWith<$Res> {
  factory $ServerMeetingDeletedCopyWith(ServerMeetingDeleted value, $Res Function(ServerMeetingDeleted) then) =
...
/// @nodoc
class _$ServerMeetingDeletedCopyWithImpl<$Res> implements $ServerMeetingDeletedCopyWith<$Res> {
...
/// @nodoc
abstract class _$ServerMeetingDeletedCopyWith<$Res> implements $ServerMeetingDeletedCopyWith<$Res> {
  factory _$ServerMeetingDeletedCopyWith(_ServerMeetingDeleted value, $Res Function(_ServerMeetingDeleted) then) =
...
/// @nodoc
class __$ServerMeetingDeletedCopyWithImpl<$Res> extends _$ServerMeetingDeletedCopyWithImpl<$Res>
    implements _$ServerMeetingDeletedCopyWith<$Res> {
  __$ServerMeetingDeletedCopyWithImpl(_ServerMeetingDeleted _value, $Res Function(_ServerMeetingDeleted) _then)
...
class _$_ServerMeetingDeleted implements _ServerMeetingDeleted {
  ...
  factory _$_ServerMeetingDeleted.fromJson(Map<String, dynamic> json) => _$$_ServerMeetingDeletedFromJson(json);
  ...
  _$ServerMeetingDeletedCopyWith<_ServerMeetingDeleted> get copyWith =>
      __$ServerMeetingDeletedCopyWithImpl<_ServerMeetingDeleted>(this, _$identity);
...
abstract class _ServerMeetingDeleted implements ServerMeetingDeleted {
  const factory _ServerMeetingDeleted(
      {@JsonKey(name: 'params') required ServerMeetingDeletedParams params,
      @JsonKey(name: 'event') required String name,
      @JsonKey(name: 'confirm_id') String? confirmId}) = _$_ServerMeetingDeleted;

  factory _ServerMeetingDeleted.fromJson(Map<String, dynamic> json) = _$_ServerMeetingDeleted.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$ServerMeetingDeletedCopyWith<_ServerMeetingDeleted> get copyWith => throw _privateConstructorUsedError;
}
