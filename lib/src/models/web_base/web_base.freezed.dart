...
mixin _$WebBase {
  ...
  @JsonKey(ignore: true)
  $WebBaseCopyWith<WebBase> get copyWith => throw _privateConstructorUsedError;
}
...
/// @nodoc
@JsonSerializable()
class _$_WebBase implements _WebBase {
  const _$_WebBase(
  ...
  factory _$_WebBase.fromJson(Map<String, dynamic> json) => _$$_WebBaseFromJson(json);
  ...
  @override
  String toString() {
    return 'WebBase(brand: $brand, brandLight: $brandLight, brandDark: $brandDark, backLight: $backLight, error: $error, errorLight: $errorLight, success: $success, successLight: $successLight, attention: $attention, attentionLight: $attentionLight, fade: $fade)';
  }
...
abstract class _WebBase implements WebBase {
  ...
  @override
  @JsonKey(ignore: true)
  _$WebBaseCopyWith<_WebBase> get copyWith => throw _privateConstructorUsedError;
}
