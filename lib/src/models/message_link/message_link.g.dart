...
_$_MessageLink _$$_MessageLinkFromJson(Map<String, dynamic> json) =>
    _$_MessageLink(
...
Map<String, dynamic> _$$_MessageLinkToJson(_$_MessageLink instance) =>
    <String, dynamic>{
