...
class _$ClientCallRejectParamsTearOff {
  ...
  _ClientCallRejectParams call({@JsonKey(name: 'jid') required String jid, @JsonKey(name: 'reason') String? reason}) {
...
mixin _$ClientCallRejectParams {
  ...
  @JsonKey(ignore: true)
  $ClientCallRejectParamsCopyWith<ClientCallRejectParams> get copyWith => throw _privateConstructorUsedError;
}
...
class _$_ClientCallRejectParams implements _ClientCallRejectParams {
  const _$_ClientCallRejectParams({@JsonKey(name: 'jid') required this.jid, @JsonKey(name: 'reason') this.reason});

  factory _$_ClientCallRejectParams.fromJson(Map<String, dynamic> json) => _$$_ClientCallRejectParamsFromJson(json);
...
abstract class _ClientCallRejectParams implements ClientCallRejectParams {
  const factory _ClientCallRejectParams(
      {@JsonKey(name: 'jid') required String jid, @JsonKey(name: 'reason') String? reason}) = _$_ClientCallRejectParams;
  ...
  @override
  @JsonKey(ignore: true)
  _$ClientCallRejectParamsCopyWith<_ClientCallRejectParams> get copyWith => throw _privateConstructorUsedError;
}
