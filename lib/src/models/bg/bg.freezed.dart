...
abstract class _$BgCopyWith<$Res> implements $BgCopyWith<$Res> {
  factory _$BgCopyWith(_Bg value, $Res Function(_Bg) then) =
      __$BgCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'badge_background') String badgeBackground,
      @JsonKey(name: 'fade') String fade});
...
/// @nodoc
class __$BgCopyWithImpl<$Res> extends _$BgCopyWithImpl<$Res>
    implements _$BgCopyWith<$Res> {
  __$BgCopyWithImpl(_Bg _value, $Res Function(_Bg) _then)
      : super(_value, (v) => _then(v as _Bg));
        ...
        (other is _Bg &&
            (identical(other.badgeBackground, badgeBackground) ||
                const DeepCollectionEquality()
                    .equals(other.badgeBackground, badgeBackground)) &&
