...
@freezed
class GetUsersInfoByUserUUIDArrayExcludingTeamMembersResponse
    with _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersResponse {
  ...
  factory GetUsersInfoByUserUUIDArrayExcludingTeamMembersResponse.fromJson(Map<String, dynamic> json) =>
      _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersResponseFromJson(json);
}
