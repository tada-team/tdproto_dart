...
class _$ServerCallLeaveParamsTearOff {
  ...
  _ServerCallLeaveParams call({@JsonKey(name: 'jid') required String jid, @JsonKey(name: 'uid') required String uid}) {
...
mixin _$ServerCallLeaveParams {
  ...
  @JsonKey(ignore: true)
  $ServerCallLeaveParamsCopyWith<ServerCallLeaveParams> get copyWith => throw _privateConstructorUsedError;
}
...
class _$_ServerCallLeaveParams implements _ServerCallLeaveParams {
  const _$_ServerCallLeaveParams({@JsonKey(name: 'jid') required this.jid, @JsonKey(name: 'uid') required this.uid});

  factory _$_ServerCallLeaveParams.fromJson(Map<String, dynamic> json) => _$$_ServerCallLeaveParamsFromJson(json);
...
abstract class _ServerCallLeaveParams implements ServerCallLeaveParams {
  ...
  @override
  @JsonKey(ignore: true)
  _$ServerCallLeaveParamsCopyWith<_ServerCallLeaveParams> get copyWith => throw _privateConstructorUsedError;
}
