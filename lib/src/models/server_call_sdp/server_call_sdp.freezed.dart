...
mixin _$ServerCallSdp {
  ...
  @JsonKey(ignore: true)
  $ServerCallSdpCopyWith<ServerCallSdp> get copyWith => throw _privateConstructorUsedError;
}
...
class _$_ServerCallSdp implements _ServerCallSdp {
  ...
  factory _$_ServerCallSdp.fromJson(Map<String, dynamic> json) => _$$_ServerCallSdpFromJson(json);
...
abstract class _ServerCallSdp implements ServerCallSdp {
  ...
  @override
  @JsonKey(ignore: true)
  _$ServerCallSdpCopyWith<_ServerCallSdp> get copyWith => throw _privateConstructorUsedError;
}
