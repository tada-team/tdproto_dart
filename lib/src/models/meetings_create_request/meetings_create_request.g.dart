...
_$_MeetingsCreateRequest _$$_MeetingsCreateRequestFromJson(
        Map<String, dynamic> json) =>
    _$_MeetingsCreateRequest(
...
Map<String, dynamic> _$$_MeetingsCreateRequestToJson(
        _$_MeetingsCreateRequest instance) =>
    <String, dynamic>{
