...
_$_CounterpartyUpdateResponse _$$_CounterpartyUpdateResponseFromJson(
        Map<String, dynamic> json) =>
    _$_CounterpartyUpdateResponse(
...
Map<String, dynamic> _$$_CounterpartyUpdateResponseToJson(
        _$_CounterpartyUpdateResponse instance) =>
    <String, dynamic>{
      'id': instance.id,
