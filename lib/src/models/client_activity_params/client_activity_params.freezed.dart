...
/// @nodoc
abstract class _$ClientActivityParamsCopyWith<$Res>
    implements $ClientActivityParamsCopyWith<$Res> {
  factory _$ClientActivityParamsCopyWith(_ClientActivityParams value,
          $Res Function(_ClientActivityParams) then) =
...
/// @nodoc
class __$ClientActivityParamsCopyWithImpl<$Res>
    extends _$ClientActivityParamsCopyWithImpl<$Res>
    implements _$ClientActivityParamsCopyWith<$Res> {
  __$ClientActivityParamsCopyWithImpl(
      _ClientActivityParams _value, $Res Function(_ClientActivityParams) _then)
...
class _$_ClientActivityParams implements _ClientActivityParams {
  ...
  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(afk);

  @JsonKey(ignore: true)
  @override
  _$ClientActivityParamsCopyWith<_ClientActivityParams> get copyWith =>
      __$ClientActivityParamsCopyWithImpl<_ClientActivityParams>(
          this, _$identity);
...
abstract class _ClientActivityParams implements ClientActivityParams {
  const factory _ClientActivityParams(
      {@JsonKey(name: 'afk') required bool afk}) = _$_ClientActivityParams;
