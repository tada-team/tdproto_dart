...
_$_InvitableUser _$$_InvitableUserFromJson(Map<String, dynamic> json) => _$_InvitableUser(
...
Map<String, dynamic> _$$_InvitableUserToJson(_$_InvitableUser instance) => <String, dynamic>{
      'uid': instance.uid,
      'node': instance.node,
