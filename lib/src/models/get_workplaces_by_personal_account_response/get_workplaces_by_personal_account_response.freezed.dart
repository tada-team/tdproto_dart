...
GetWorkplacesByPersonalAccountResponse _$GetWorkplacesByPersonalAccountResponseFromJson(Map<String, dynamic> json) {
...
class _$GetWorkplacesByPersonalAccountResponseTearOff {
  ...
  _GetWorkplacesByPersonalAccountResponse call({@JsonKey(name: 'workplaces') List<WorkplaceBilling>? workplaces}) {
...
/// @nodoc
const $GetWorkplacesByPersonalAccountResponse = _$GetWorkplacesByPersonalAccountResponseTearOff();
...
mixin _$GetWorkplacesByPersonalAccountResponse {
  ...
  @JsonKey(ignore: true)
  $GetWorkplacesByPersonalAccountResponseCopyWith<GetWorkplacesByPersonalAccountResponse> get copyWith =>
...
abstract class $GetWorkplacesByPersonalAccountResponseCopyWith<$Res> {
  factory $GetWorkplacesByPersonalAccountResponseCopyWith(
          GetWorkplacesByPersonalAccountResponse value, $Res Function(GetWorkplacesByPersonalAccountResponse) then) =
...
abstract class _$GetWorkplacesByPersonalAccountResponseCopyWith<$Res>
  ...
  factory _$GetWorkplacesByPersonalAccountResponseCopyWith(
          _GetWorkplacesByPersonalAccountResponse value, $Res Function(_GetWorkplacesByPersonalAccountResponse) then) =
...
class __$GetWorkplacesByPersonalAccountResponseCopyWithImpl<$Res>
  ...
  __$GetWorkplacesByPersonalAccountResponseCopyWithImpl(
      _GetWorkplacesByPersonalAccountResponse _value, $Res Function(_GetWorkplacesByPersonalAccountResponse) _then)
      : super(_value, (v) => _then(v as _GetWorkplacesByPersonalAccountResponse));

  @override
  _GetWorkplacesByPersonalAccountResponse get _value => super._value as _GetWorkplacesByPersonalAccountResponse;
...
/// @nodoc
@JsonSerializable()
class _$_GetWorkplacesByPersonalAccountResponse implements _GetWorkplacesByPersonalAccountResponse {
  const _$_GetWorkplacesByPersonalAccountResponse({@JsonKey(name: 'workplaces') this.workplaces});

  factory _$_GetWorkplacesByPersonalAccountResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(ignore: true)
  @override
  _$GetWorkplacesByPersonalAccountResponseCopyWith<_GetWorkplacesByPersonalAccountResponse> get copyWith =>
      __$GetWorkplacesByPersonalAccountResponseCopyWithImpl<_GetWorkplacesByPersonalAccountResponse>(this, _$identity);
...
abstract class _GetWorkplacesByPersonalAccountResponse implements GetWorkplacesByPersonalAccountResponse {
  const factory _GetWorkplacesByPersonalAccountResponse(
      {@JsonKey(name: 'workplaces') List<WorkplaceBilling>? workplaces}) = _$_GetWorkplacesByPersonalAccountResponse;

  factory _GetWorkplacesByPersonalAccountResponse.fromJson(Map<String, dynamic> json) =
