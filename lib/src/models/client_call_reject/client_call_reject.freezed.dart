...
// ignore: unused_element
  _ClientCallReject call(
      {@required @JsonKey(name: 'params') ClientCallRejectParams params,
...
class _$ClientCallRejectCopyWithImpl<$Res> implements $ClientCallRejectCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      params: params == freezed ? _value.params : params as ClientCallRejectParams,
...
class _$_ClientCallReject implements _ClientCallReject {
  ...
  factory _$_ClientCallReject.fromJson(Map<String, dynamic> json) => _$_$_ClientCallRejectFromJson(json);
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$_$_ClientCallRejectToJson(this);
  }
}
