...
GetActiveTariffsListResponse _$GetActiveTariffsListResponseFromJson(Map<String, dynamic> json) {
...
class _$GetActiveTariffsListResponseTearOff {
  ...
  _GetActiveTariffsListResponse call({@JsonKey(name: 'tariffs') required List<TariffBilling> tariffs}) {
...
mixin _$GetActiveTariffsListResponse {
  ...
  @JsonKey(ignore: true)
  $GetActiveTariffsListResponseCopyWith<GetActiveTariffsListResponse> get copyWith =>
...
abstract class $GetActiveTariffsListResponseCopyWith<$Res> {
  factory $GetActiveTariffsListResponseCopyWith(
          GetActiveTariffsListResponse value, $Res Function(GetActiveTariffsListResponse) then) =
      _$GetActiveTariffsListResponseCopyWithImpl<$Res>;
  $Res call({@JsonKey(name: 'tariffs') List<TariffBilling> tariffs});
}

/// @nodoc
class _$GetActiveTariffsListResponseCopyWithImpl<$Res> implements $GetActiveTariffsListResponseCopyWith<$Res> {
...
/// @nodoc
abstract class _$GetActiveTariffsListResponseCopyWith<$Res> implements $GetActiveTariffsListResponseCopyWith<$Res> {
  factory _$GetActiveTariffsListResponseCopyWith(
          _GetActiveTariffsListResponse value, $Res Function(_GetActiveTariffsListResponse) then) =
...
/// @nodoc
class __$GetActiveTariffsListResponseCopyWithImpl<$Res> extends _$GetActiveTariffsListResponseCopyWithImpl<$Res>
    implements _$GetActiveTariffsListResponseCopyWith<$Res> {
  __$GetActiveTariffsListResponseCopyWithImpl(
      _GetActiveTariffsListResponse _value, $Res Function(_GetActiveTariffsListResponse) _then)
      : super(_value, (v) => _then(v as _GetActiveTariffsListResponse));

  @override
  _GetActiveTariffsListResponse get _value => super._value as _GetActiveTariffsListResponse;
...
class _$_GetActiveTariffsListResponse implements _GetActiveTariffsListResponse {
  const _$_GetActiveTariffsListResponse({@JsonKey(name: 'tariffs') required this.tariffs});
  ...
  @JsonKey(ignore: true)
  @override
  _$GetActiveTariffsListResponseCopyWith<_GetActiveTariffsListResponse> get copyWith =>
      __$GetActiveTariffsListResponseCopyWithImpl<_GetActiveTariffsListResponse>(this, _$identity);
...
abstract class _GetActiveTariffsListResponse implements GetActiveTariffsListResponse {
  const factory _GetActiveTariffsListResponse({@JsonKey(name: 'tariffs') required List<TariffBilling> tariffs}) =
      _$_GetActiveTariffsListResponse;

  factory _GetActiveTariffsListResponse.fromJson(Map<String, dynamic> json) = _$_GetActiveTariffsListResponse.fromJson;
