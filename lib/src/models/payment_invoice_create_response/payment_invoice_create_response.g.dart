...
_$_PaymentInvoiceCreateResponse _$$_PaymentInvoiceCreateResponseFromJson(
...
Map<String, dynamic> _$$_PaymentInvoiceCreateResponseToJson(
        _$_PaymentInvoiceCreateResponse instance) =>
    <String, dynamic>{
      'id': instance.id,
