...
EnquiryCreateResponse _$EnquiryCreateResponseFromJson(
    Map<String, dynamic> json) {
  return _EnquiryCreateResponse.fromJson(json);
}

/// @nodoc
class _$EnquiryCreateResponseTearOff {
  const _$EnquiryCreateResponseTearOff();

  _EnquiryCreateResponse call(
      {@JsonKey(name: 'id')
          required String id,
  ...
  EnquiryCreateResponse fromJson(Map<String, Object> json) {
    return EnquiryCreateResponse.fromJson(json);
  }
}

/// @nodoc
const $EnquiryCreateResponse = _$EnquiryCreateResponseTearOff();

/// @nodoc
mixin _$EnquiryCreateResponse {
  /// .
  @JsonKey(name: 'id')
  ...
  @JsonKey(ignore: true)
  $EnquiryCreateResponseCopyWith<EnquiryCreateResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EnquiryCreateResponseCopyWith<$Res> {
  factory $EnquiryCreateResponseCopyWith(EnquiryCreateResponse value,
          $Res Function(EnquiryCreateResponse) then) =
      _$EnquiryCreateResponseCopyWithImpl<$Res>;
  $Res call(
...
/// @nodoc
class _$EnquiryCreateResponseCopyWithImpl<$Res>
    implements $EnquiryCreateResponseCopyWith<$Res> {
  _$EnquiryCreateResponseCopyWithImpl(this._value, this._then);

  final EnquiryCreateResponse _value;
  // ignore: unused_field
  final $Res Function(EnquiryCreateResponse) _then;
...
/// @nodoc
abstract class _$EnquiryCreateResponseCopyWith<$Res>
    implements $EnquiryCreateResponseCopyWith<$Res> {
  factory _$EnquiryCreateResponseCopyWith(_EnquiryCreateResponse value,
          $Res Function(_EnquiryCreateResponse) then) =
      __$EnquiryCreateResponseCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'id') String id,
      @JsonKey(name: 'personal_account_id') String personalAccountId,
...
/// @nodoc
class __$EnquiryCreateResponseCopyWithImpl<$Res>
    extends _$EnquiryCreateResponseCopyWithImpl<$Res>
    implements _$EnquiryCreateResponseCopyWith<$Res> {
  __$EnquiryCreateResponseCopyWithImpl(_EnquiryCreateResponse _value,
      $Res Function(_EnquiryCreateResponse) _then)
      : super(_value, (v) => _then(v as _EnquiryCreateResponse));

  @override
  _EnquiryCreateResponse get _value => super._value as _EnquiryCreateResponse;
  ...
  $Res call({
    ...
    return _then(_EnquiryCreateResponse(
      id: id == freezed
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_EnquiryCreateResponse implements _EnquiryCreateResponse {
  const _$_EnquiryCreateResponse(
      {@JsonKey(name: 'id')
          required this.id,
      @JsonKey(name: 'personal_account_id')
  ...
  factory _$_EnquiryCreateResponse.fromJson(Map<String, dynamic> json) =>
      _$$_EnquiryCreateResponseFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  _$EnquiryCreateResponseCopyWith<_EnquiryCreateResponse> get copyWith =>
      __$EnquiryCreateResponseCopyWithImpl<_EnquiryCreateResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_EnquiryCreateResponseToJson(this);
  }
}

abstract class _EnquiryCreateResponse implements EnquiryCreateResponse {
  const factory _EnquiryCreateResponse(
      {@JsonKey(name: 'id')
          required String id,
      @JsonKey(name: 'personal_account_id')
          required String personalAccountId,
      ...
      @JsonKey(name: 'file_name')
          String? fileName,
      @JsonKey(name: 'media_url')
          String? mediaUrl}) = _$_EnquiryCreateResponse;

  factory _EnquiryCreateResponse.fromJson(Map<String, dynamic> json) =
      _$_EnquiryCreateResponse.fromJson;
