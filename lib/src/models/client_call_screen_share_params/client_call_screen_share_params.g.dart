...
_$_ClientCallScreenShareParams _$$_ClientCallScreenShareParamsFromJson(
...
Map<String, dynamic> _$$_ClientCallScreenShareParamsToJson(
        _$_ClientCallScreenShareParams instance) =>
    <String, dynamic>{
