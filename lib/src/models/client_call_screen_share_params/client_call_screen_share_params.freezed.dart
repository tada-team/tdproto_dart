...
ClientCallScreenShareParams _$ClientCallScreenShareParamsFromJson(Map<String, dynamic> json) {
...
mixin _$ClientCallScreenShareParams {
  ...
  @JsonKey(ignore: true)
  $ClientCallScreenShareParamsCopyWith<ClientCallScreenShareParams> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ClientCallScreenShareParamsCopyWith<$Res> {
  factory $ClientCallScreenShareParamsCopyWith(
          ClientCallScreenShareParams value, $Res Function(ClientCallScreenShareParams) then) =
      _$ClientCallScreenShareParamsCopyWithImpl<$Res>;
  $Res call({@JsonKey(name: 'screenshare_enabled') bool screenShareEnabled, @JsonKey(name: 'call_jid') String callJid});
}

/// @nodoc
class _$ClientCallScreenShareParamsCopyWithImpl<$Res> implements $ClientCallScreenShareParamsCopyWith<$Res> {
...
/// @nodoc
abstract class _$ClientCallScreenShareParamsCopyWith<$Res> implements $ClientCallScreenShareParamsCopyWith<$Res> {
  factory _$ClientCallScreenShareParamsCopyWith(
          _ClientCallScreenShareParams value, $Res Function(_ClientCallScreenShareParams) then) =
...
/// @nodoc
class __$ClientCallScreenShareParamsCopyWithImpl<$Res> extends _$ClientCallScreenShareParamsCopyWithImpl<$Res>
    implements _$ClientCallScreenShareParamsCopyWith<$Res> {
  __$ClientCallScreenShareParamsCopyWithImpl(
      _ClientCallScreenShareParams _value, $Res Function(_ClientCallScreenShareParams) _then)
      : super(_value, (v) => _then(v as _ClientCallScreenShareParams));

  @override
  _ClientCallScreenShareParams get _value => super._value as _ClientCallScreenShareParams;
...
class _$_ClientCallScreenShareParams implements _ClientCallScreenShareParams {
  ...
  @JsonKey(ignore: true)
  @override
  _$ClientCallScreenShareParamsCopyWith<_ClientCallScreenShareParams> get copyWith =>
      __$ClientCallScreenShareParamsCopyWithImpl<_ClientCallScreenShareParams>(this, _$identity);
...
abstract class _ClientCallScreenShareParams implements ClientCallScreenShareParams {
  const factory _ClientCallScreenShareParams(
      {@JsonKey(name: 'screenshare_enabled') required bool screenShareEnabled,
      @JsonKey(name: 'call_jid') required String callJid}) = _$_ClientCallScreenShareParams;

  factory _ClientCallScreenShareParams.fromJson(Map<String, dynamic> json) = _$_ClientCallScreenShareParams.fromJson;
