...
_$_MeetingsMembersGetRequestParams _$$_MeetingsMembersGetRequestParamsFromJson(
        Map<String, dynamic> json) =>
    _$_MeetingsMembersGetRequestParams(
      meetingId: json['meeting_id'] as String,
      teamUuid: json['team_uuid'] as String,
      uuidSections: (json['uuid_sections'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
...
Map<String, dynamic> _$$_MeetingsMembersGetRequestParamsToJson(
        _$_MeetingsMembersGetRequestParams instance) =>
    <String, dynamic>{
