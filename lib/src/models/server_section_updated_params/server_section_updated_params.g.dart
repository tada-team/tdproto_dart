...
_$_ServerSectionUpdatedParams _$$_ServerSectionUpdatedParamsFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$_ServerSectionUpdatedParamsToJson(_$_ServerSectionUpdatedParams instance) => <String, dynamic>{
