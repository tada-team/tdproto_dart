...
class _$ServerTeamDeletedParamsTearOff {
  ...
  _ServerTeamDeletedParams call({@JsonKey(name: 'teams') required List<DeletedTeam> teams}) {
...
mixin _$ServerTeamDeletedParams {
  ...
  @JsonKey(ignore: true)
  $ServerTeamDeletedParamsCopyWith<ServerTeamDeletedParams> get copyWith => throw _privateConstructorUsedError;
}
...
class _$_ServerTeamDeletedParams implements _ServerTeamDeletedParams {
  const _$_ServerTeamDeletedParams({@JsonKey(name: 'teams') required this.teams});

  factory _$_ServerTeamDeletedParams.fromJson(Map<String, dynamic> json) => _$$_ServerTeamDeletedParamsFromJson(json);
...
abstract class _ServerTeamDeletedParams implements ServerTeamDeletedParams {
  const factory _ServerTeamDeletedParams({@JsonKey(name: 'teams') required List<DeletedTeam> teams}) =
  ...
  @override
  @JsonKey(ignore: true)
  _$ServerTeamDeletedParamsCopyWith<_ServerTeamDeletedParams> get copyWith => throw _privateConstructorUsedError;
}
