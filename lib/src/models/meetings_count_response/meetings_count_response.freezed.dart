...
/// @nodoc
abstract class _$MeetingsCountResponseCopyWith<$Res>
    implements $MeetingsCountResponseCopyWith<$Res> {
  factory _$MeetingsCountResponseCopyWith(_MeetingsCountResponse value,
          $Res Function(_MeetingsCountResponse) then) =
...
/// @nodoc
class __$MeetingsCountResponseCopyWithImpl<$Res>
    extends _$MeetingsCountResponseCopyWithImpl<$Res>
    implements _$MeetingsCountResponseCopyWith<$Res> {
  __$MeetingsCountResponseCopyWithImpl(_MeetingsCountResponse _value,
      $Res Function(_MeetingsCountResponse) _then)
...
class _$_MeetingsCountResponse implements _MeetingsCountResponse {
        ...
        (other is _MeetingsCountResponse &&
            (identical(other.countCells, countCells) ||
                const DeepCollectionEquality()
                    .equals(other.countCells, countCells)) &&
            (identical(other.countMeetings, countMeetings) ||
                const DeepCollectionEquality()
                    .equals(other.countMeetings, countMeetings)));
  }
  ...
  _$MeetingsCountResponseCopyWith<_MeetingsCountResponse> get copyWith =>
      __$MeetingsCountResponseCopyWithImpl<_MeetingsCountResponse>(
          this, _$identity);
