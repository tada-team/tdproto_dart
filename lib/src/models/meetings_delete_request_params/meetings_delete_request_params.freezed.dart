...
class _$MeetingsDeleteRequestParamsTearOff {
  ...
  _MeetingsDeleteRequestParams call({@JsonKey(name: 'date') @DateTimeConverter() DateTime? date}) {
...
abstract class $MeetingsDeleteRequestParamsCopyWith<$Res> {
  ...
  $Res call({@JsonKey(name: 'date') @DateTimeConverter() DateTime? date});
}
...
class _$_MeetingsDeleteRequestParams implements _MeetingsDeleteRequestParams {
  const _$_MeetingsDeleteRequestParams({@JsonKey(name: 'date') @DateTimeConverter() this.date});
  ...
  @override
  String toString() {
    return 'MeetingsDeleteRequestParams(date: $date)';
  }
...
abstract class _MeetingsDeleteRequestParams implements MeetingsDeleteRequestParams {
  const factory _MeetingsDeleteRequestParams({@JsonKey(name: 'date') @DateTimeConverter() DateTime? date}) =
