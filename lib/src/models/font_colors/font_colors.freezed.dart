...
class _$_FontColors implements _FontColors {
  const _$_FontColors(
      ...
      @required @JsonKey(name: 'sub') this.sub,
      @required @JsonKey(name: 'brand_button') this.brandButton,
      @required @JsonKey(name: 'simple_button') this.simpleButton,
      @required @JsonKey(name: 'bubble_sent') this.bubbleSent,
      @required @JsonKey(name: 'bubble_received') this.bubbleReceived})
      : assert(text != null),
        assert(title != null),
        assert(sub != null),
        assert(brandButton != null),
        assert(simpleButton != null),
  ...
  @override
  String toString() {
    return 'FontColors(text: $text, title: $title, sub: $sub, brandButton: $brandButton, simpleButton: $simpleButton, bubbleSent: $bubbleSent, bubbleReceived: $bubbleReceived)';
  }
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$_$_FontColorsToJson(this);
  }
}
