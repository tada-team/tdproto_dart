...
_$_ServerCallAnswerParams _$$_ServerCallAnswerParamsFromJson(Map<String, dynamic> json) => _$_ServerCallAnswerParams(
      jid: json['jid'] as String,
      candidates: (json['candidates'] as List<dynamic>?)
          ?.map((e) => ServerCallAnswerCandidate.fromJson(e as Map<String, dynamic>))
          .toList(),
      onliners:
...
Map<String, dynamic> _$$_ServerCallAnswerParamsToJson(_$_ServerCallAnswerParams instance) => <String, dynamic>{
      'jid': instance.jid,
