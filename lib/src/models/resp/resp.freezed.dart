...
abstract class _$RespCopyWith<$Res> implements $RespCopyWith<$Res> {
  factory _$RespCopyWith(_Resp value, $Res Function(_Resp) then) =
      __$RespCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: '_time') String? debugTime,
      @JsonKey(name: 'ok') bool ok,
...
/// @nodoc
class __$RespCopyWithImpl<$Res> extends _$RespCopyWithImpl<$Res>
    implements _$RespCopyWith<$Res> {
  __$RespCopyWithImpl(_Resp _value, $Res Function(_Resp) _then)
      : super(_value, (v) => _then(v as _Resp));
...
class _$_Resp implements _Resp {
        ...
        (other is _Resp &&
            (identical(other.debugTime, debugTime) ||
                const DeepCollectionEquality()
                    .equals(other.debugTime, debugTime)) &&
  ...
  _$RespCopyWith<_Resp> get copyWith =>
      __$RespCopyWithImpl<_Resp>(this, _$identity);
