...
_$_PaymentInvoiceUpdateResponse _$$_PaymentInvoiceUpdateResponseFromJson(
...
Map<String, dynamic> _$$_PaymentInvoiceUpdateResponseToJson(
        _$_PaymentInvoiceUpdateResponse instance) =>
    <String, dynamic>{
      'id': instance.id,
