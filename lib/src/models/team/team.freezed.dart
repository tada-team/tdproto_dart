...
class _$TeamTearOff {
  ...
  _Team call(
      ...
      @JsonKey(name: 'last_active') required bool lastActive = false,
      @JsonKey(name: 'changeable_statuses') List<String>? changeableStatuses,
      @JsonKey(name: 'bad_profile') bool? badProfile = false,
      @JsonKey(name: 'need_confirmation') required bool needConfirmation = false,
      @JsonKey(name: 'use_patronymic') bool? usePatronymic = false,
      @JsonKey(name: 'user_fields') required List<String> userFields,
      @JsonKey(name: 'display_family_name_first') bool? displayFamilyNameFirst = false,
      @JsonKey(name: 'use_task_importance') bool? useTaskImportance = false,
      @JsonKey(name: 'task_importance_min') int? taskImportanceMin,
      @JsonKey(name: 'task_importance_max') int? taskImportanceMax,
      @JsonKey(name: 'task_importance_rev') bool? taskImportanceRev = false,
      @JsonKey(name: 'use_task_urgency') bool? useTaskUrgency = false,
      @JsonKey(name: 'use_task_complexity') bool? useTaskComplexity = false,
      @JsonKey(name: 'use_task_spent_time') bool? useTaskSpentTime = false,
      ...
      @JsonKey(name: 'hide_archived_users') bool? hideArchivedUsers = false,
...
class _$_Team implements _Team {
  const _$_Team(
      ...
      @JsonKey(name: 'last_active') required this.lastActive = false,
      @JsonKey(name: 'changeable_statuses') this.changeableStatuses,
      @JsonKey(name: 'bad_profile') this.badProfile = false,
      @JsonKey(name: 'need_confirmation') required this.needConfirmation = false,
      @JsonKey(name: 'use_patronymic') this.usePatronymic = false,
      @JsonKey(name: 'user_fields') required this.userFields,
      @JsonKey(name: 'display_family_name_first') this.displayFamilyNameFirst = false,
      @JsonKey(name: 'use_task_importance') this.useTaskImportance = false,
      @JsonKey(name: 'task_importance_min') this.taskImportanceMin,
      @JsonKey(name: 'task_importance_max') this.taskImportanceMax,
      @JsonKey(name: 'task_importance_rev') this.taskImportanceRev = false,
      @JsonKey(name: 'use_task_urgency') this.useTaskUrgency = false,
      @JsonKey(name: 'use_task_complexity') this.useTaskComplexity = false,
      @JsonKey(name: 'use_task_spent_time') this.useTaskSpentTime = false,
      ...
      @JsonKey(name: 'hide_archived_users') this.hideArchivedUsers = false,
