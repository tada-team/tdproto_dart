...
_$_ServerMessageUpdatedParams _$$_ServerMessageUpdatedParamsFromJson(
...
Map<String, dynamic> _$$_ServerMessageUpdatedParamsToJson(
        _$_ServerMessageUpdatedParams instance) =>
    <String, dynamic>{
