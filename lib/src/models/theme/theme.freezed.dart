...
mixin _$Theme {
  ...
  MessageColors get message;

  /// Switcher colors for app.
  @JsonKey(name: 'switcher')
  SwitcherColors get switcher;

  /// Button colors for app.
  @JsonKey(name: 'button')
  ButtonColors get button;

  /// Input colors for app.
  @JsonKey(name: 'input')
  InputColors get input;
...
class _$_Theme implements _Theme {
  const _$_Theme(
      ...
      : assert(bgColor != null),
        ...
        assert(mutedTextColor != null),
        assert(accentColor != null),
        assert(accentHoverColor != null),
        assert(textOnAccentHoverColor != null),
        assert(mainAccent != null),
        assert(mainAccentHover != null),
        assert(mainLightAccent != null),
        assert(mainLink != null),
        assert(brand != null),
        assert(brandDark != null),
        assert(brandLight != null),
        assert(back != null),
        assert(backLight != null),
        assert(backDark != null),
        assert(success != null),
        assert(successLight != null),
        assert(error != null),
        assert(errorLight != null),
        assert(background != null),
        assert(tabBackground != null),
        assert(chatInputBackground != null),
        assert(substrateBackground != null),
        assert(modalBackground != null),
        assert(titleBackground != null),
