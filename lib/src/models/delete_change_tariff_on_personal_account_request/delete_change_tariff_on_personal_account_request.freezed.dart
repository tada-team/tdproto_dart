...
DeleteChangeTariffOnPersonalAccountRequest _$DeleteChangeTariffOnPersonalAccountRequestFromJson(
...
class _$DeleteChangeTariffOnPersonalAccountRequestTearOff {
  ...
  _DeleteChangeTariffOnPersonalAccountRequest call({@JsonKey(name: 'tariff_id') required String tariffId}) {
    return _DeleteChangeTariffOnPersonalAccountRequest(
      tariffId: tariffId,
    );
  }

  DeleteChangeTariffOnPersonalAccountRequest fromJson(Map<String, Object> json) {
    return DeleteChangeTariffOnPersonalAccountRequest.fromJson(json);
  }
}

/// @nodoc
const $DeleteChangeTariffOnPersonalAccountRequest = _$DeleteChangeTariffOnPersonalAccountRequestTearOff();
...
mixin _$DeleteChangeTariffOnPersonalAccountRequest {
  ...
  @JsonKey(ignore: true)
  $DeleteChangeTariffOnPersonalAccountRequestCopyWith<DeleteChangeTariffOnPersonalAccountRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DeleteChangeTariffOnPersonalAccountRequestCopyWith<$Res> {
  factory $DeleteChangeTariffOnPersonalAccountRequestCopyWith(DeleteChangeTariffOnPersonalAccountRequest value,
...
class _$DeleteChangeTariffOnPersonalAccountRequestCopyWithImpl<$Res>
  ...
  _$DeleteChangeTariffOnPersonalAccountRequestCopyWithImpl(this._value, this._then);
...
abstract class _$DeleteChangeTariffOnPersonalAccountRequestCopyWith<$Res>
    implements $DeleteChangeTariffOnPersonalAccountRequestCopyWith<$Res> {
  factory _$DeleteChangeTariffOnPersonalAccountRequestCopyWith(_DeleteChangeTariffOnPersonalAccountRequest value,
...
class __$DeleteChangeTariffOnPersonalAccountRequestCopyWithImpl<$Res>
  ...
  __$DeleteChangeTariffOnPersonalAccountRequestCopyWithImpl(_DeleteChangeTariffOnPersonalAccountRequest _value,
      $Res Function(_DeleteChangeTariffOnPersonalAccountRequest) _then)
      : super(_value, (v) => _then(v as _DeleteChangeTariffOnPersonalAccountRequest));

  @override
  _DeleteChangeTariffOnPersonalAccountRequest get _value => super._value as _DeleteChangeTariffOnPersonalAccountRequest;
...
/// @nodoc
@JsonSerializable()
class _$_DeleteChangeTariffOnPersonalAccountRequest implements _DeleteChangeTariffOnPersonalAccountRequest {
  const _$_DeleteChangeTariffOnPersonalAccountRequest({@JsonKey(name: 'tariff_id') required this.tariffId});

  factory _$_DeleteChangeTariffOnPersonalAccountRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(ignore: true)
  @override
  _$DeleteChangeTariffOnPersonalAccountRequestCopyWith<_DeleteChangeTariffOnPersonalAccountRequest> get copyWith =>
      __$DeleteChangeTariffOnPersonalAccountRequestCopyWithImpl<_DeleteChangeTariffOnPersonalAccountRequest>(
          this, _$identity);
...
abstract class _DeleteChangeTariffOnPersonalAccountRequest implements DeleteChangeTariffOnPersonalAccountRequest {
  const factory _DeleteChangeTariffOnPersonalAccountRequest({@JsonKey(name: 'tariff_id') required String tariffId}) =
      _$_DeleteChangeTariffOnPersonalAccountRequest;

  factory _DeleteChangeTariffOnPersonalAccountRequest.fromJson(Map<String, dynamic> json) =
