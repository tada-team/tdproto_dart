...
mixin _$ServerTime {
  ...
  @JsonKey(ignore: true)
  $ServerTimeCopyWith<ServerTime> get copyWith => throw _privateConstructorUsedError;
}
...
class _$_ServerTime implements _ServerTime {
  ...
  factory _$_ServerTime.fromJson(Map<String, dynamic> json) => _$$_ServerTimeFromJson(json);
...
abstract class _ServerTime implements ServerTime {
  ...
  @override
  @JsonKey(ignore: true)
  _$ServerTimeCopyWith<_ServerTime> get copyWith => throw _privateConstructorUsedError;
}
