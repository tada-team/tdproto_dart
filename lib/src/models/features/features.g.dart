...
_$_Features _$$_FeaturesFromJson(Map<String, dynamic> json) => _$_Features(
      ...
      freeRegistration: json['free_registration'] as bool? ?? false,
      ...
      multiNodes: json['multi_nodes'] as bool? ?? false,
      afkAge: json['afk_age'] as int,
      authByPassword: json['auth_by_password'] as bool? ?? false,
      ...
      customServer: json['custom_server'] as bool? ?? false,
      ...
      serverDrafts: json['server_drafts'] as bool? ?? false,
      ...
      mobileCalls: json['mobile_calls'] as bool? ?? false,
      callsRecord: json['calls_record'] as bool? ?? false,
      onlyOneDevicePerCall: json['only_one_device_per_call'] as bool? ?? false,
      maxParticipantsPerCall: json['max_participants_per_call'] as int?,
      safariPushId: json['safari_push_id'] as String,
      messageUploads: json['message_uploads'] as bool? ?? false,
      terms: Terms.fromJson(json['terms'] as Map<String, dynamic>),
      singleGroupTeams: json['single_group_teams'] as bool? ?? false,
      wikiPages: json['wiki_pages'] as bool? ?? false,
      allowAdminMute: json['allow_admin_mute'] as bool? ?? false,
      defaultWallpaper: json['default_wallpaper'] == null
          ? null
          : Wallpaper.fromJson(json['default_wallpaper'] as Map<String, dynamic>),
      supportEmail: json['support_email'] as String,
      customTheme: json['custom_theme'] as bool? ?? false,
      taskChecklist: json['task_checklist'] as bool? ?? false,
      readonlyGroups: json['readonly_groups'] as bool? ?? false,
      taskDashboard: json['task_dashboard'] as bool? ?? false,
      taskMessages: json['task_messages'] as bool? ?? false,
      taskPublic: json['task_public'] as bool? ?? false,
