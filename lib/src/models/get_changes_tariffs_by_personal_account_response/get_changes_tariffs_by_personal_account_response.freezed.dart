...
GetChangesTariffsByPersonalAccountResponse _$GetChangesTariffsByPersonalAccountResponseFromJson(
...
class _$GetChangesTariffsByPersonalAccountResponseTearOff {
  ...
  GetChangesTariffsByPersonalAccountResponse fromJson(Map<String, Object> json) {
    return GetChangesTariffsByPersonalAccountResponse.fromJson(json);
  }
}

/// @nodoc
const $GetChangesTariffsByPersonalAccountResponse = _$GetChangesTariffsByPersonalAccountResponseTearOff();

/// @nodoc
mixin _$GetChangesTariffsByPersonalAccountResponse {
  /// .
  @JsonKey(name: 'tariffs_changes')
  List<ChangeTariffBilling>? get tariffsChanges => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $GetChangesTariffsByPersonalAccountResponseCopyWith<GetChangesTariffsByPersonalAccountResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetChangesTariffsByPersonalAccountResponseCopyWith<$Res> {
  factory $GetChangesTariffsByPersonalAccountResponseCopyWith(GetChangesTariffsByPersonalAccountResponse value,
          $Res Function(GetChangesTariffsByPersonalAccountResponse) then) =
      _$GetChangesTariffsByPersonalAccountResponseCopyWithImpl<$Res>;
  $Res call({@JsonKey(name: 'tariffs_changes') List<ChangeTariffBilling>? tariffsChanges});
}
...
class _$GetChangesTariffsByPersonalAccountResponseCopyWithImpl<$Res>
  ...
  _$GetChangesTariffsByPersonalAccountResponseCopyWithImpl(this._value, this._then);
...
abstract class _$GetChangesTariffsByPersonalAccountResponseCopyWith<$Res>
    implements $GetChangesTariffsByPersonalAccountResponseCopyWith<$Res> {
  factory _$GetChangesTariffsByPersonalAccountResponseCopyWith(_GetChangesTariffsByPersonalAccountResponse value,
...
class __$GetChangesTariffsByPersonalAccountResponseCopyWithImpl<$Res>
  ...
  __$GetChangesTariffsByPersonalAccountResponseCopyWithImpl(_GetChangesTariffsByPersonalAccountResponse _value,
      $Res Function(_GetChangesTariffsByPersonalAccountResponse) _then)
      : super(_value, (v) => _then(v as _GetChangesTariffsByPersonalAccountResponse));

  @override
  _GetChangesTariffsByPersonalAccountResponse get _value => super._value as _GetChangesTariffsByPersonalAccountResponse;
...
/// @nodoc
@JsonSerializable()
class _$_GetChangesTariffsByPersonalAccountResponse implements _GetChangesTariffsByPersonalAccountResponse {
  const _$_GetChangesTariffsByPersonalAccountResponse({@JsonKey(name: 'tariffs_changes') this.tariffsChanges});

  factory _$_GetChangesTariffsByPersonalAccountResponse.fromJson(Map<String, dynamic> json) =>
    ...
    return identical(this, other) ||
        (other is _GetChangesTariffsByPersonalAccountResponse &&
            (identical(other.tariffsChanges, tariffsChanges) ||
                const DeepCollectionEquality().equals(other.tariffsChanges, tariffsChanges)));
  }

  @override
  int get hashCode => runtimeType.hashCode ^ const DeepCollectionEquality().hash(tariffsChanges);

  @JsonKey(ignore: true)
  @override
  _$GetChangesTariffsByPersonalAccountResponseCopyWith<_GetChangesTariffsByPersonalAccountResponse> get copyWith =>
      __$GetChangesTariffsByPersonalAccountResponseCopyWithImpl<_GetChangesTariffsByPersonalAccountResponse>(
          this, _$identity);
...
abstract class _GetChangesTariffsByPersonalAccountResponse implements GetChangesTariffsByPersonalAccountResponse {
  const factory _GetChangesTariffsByPersonalAccountResponse(
          {@JsonKey(name: 'tariffs_changes') List<ChangeTariffBilling>? tariffsChanges}) =
      _$_GetChangesTariffsByPersonalAccountResponse;

  factory _GetChangesTariffsByPersonalAccountResponse.fromJson(Map<String, dynamic> json) =
