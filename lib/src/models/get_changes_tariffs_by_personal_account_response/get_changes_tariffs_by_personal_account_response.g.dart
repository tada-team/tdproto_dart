...
_$_GetChangesTariffsByPersonalAccountResponse
    _$$_GetChangesTariffsByPersonalAccountResponseFromJson(
            Map<String, dynamic> json) =>
        _$_GetChangesTariffsByPersonalAccountResponse(
          tariffsChanges: (json['tariffs_changes'] as List<dynamic>?)
              ?.map((e) =>
                  ChangeTariffBilling.fromJson(e as Map<String, dynamic>))
              .toList(),
        );
...
Map<String, dynamic> _$$_GetChangesTariffsByPersonalAccountResponseToJson(
    ...
    <String, dynamic>{
      'tariffs_changes':
          instance.tariffsChanges?.map((e) => e.toJson()).toList(),
    };
