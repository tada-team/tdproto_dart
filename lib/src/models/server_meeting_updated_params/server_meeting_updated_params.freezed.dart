...
class _$ServerMeetingUpdatedParamsTearOff {
  ...
  _ServerMeetingUpdatedParams call(
      ...
      @JsonKey(name: 'team_meetings_count')
          required int teamMeetingsCount,
      @JsonKey(name: 'user_meetings_count')
          required int userMeetingsCount,
      @JsonKey(name: 'team_meetings_dates')
          required List<String> teamMeetingsDates,
      @JsonKey(name: 'user_meetings_dates')
          required List<String> userMeetingsDates}) {
...
/// @nodoc
abstract class _$ServerMeetingUpdatedParamsCopyWith<$Res>
    implements $ServerMeetingUpdatedParamsCopyWith<$Res> {
  factory _$ServerMeetingUpdatedParamsCopyWith(
          _ServerMeetingUpdatedParams value,
          $Res Function(_ServerMeetingUpdatedParams) then) =
...
/// @nodoc
class __$ServerMeetingUpdatedParamsCopyWithImpl<$Res>
    extends _$ServerMeetingUpdatedParamsCopyWithImpl<$Res>
    implements _$ServerMeetingUpdatedParamsCopyWith<$Res> {
  __$ServerMeetingUpdatedParamsCopyWithImpl(_ServerMeetingUpdatedParams _value,
      $Res Function(_ServerMeetingUpdatedParams) _then)
      : super(_value, (v) => _then(v as _ServerMeetingUpdatedParams));

  @override
  _ServerMeetingUpdatedParams get _value =>
      super._value as _ServerMeetingUpdatedParams;
...
class _$_ServerMeetingUpdatedParams implements _ServerMeetingUpdatedParams {
    ...
    return identical(this, other) ||
        (other is _ServerMeetingUpdatedParams &&
            ...
            (identical(other.teamMeetingsCount, teamMeetingsCount) ||
                const DeepCollectionEquality()
                    .equals(other.teamMeetingsCount, teamMeetingsCount)) &&
            (identical(other.userMeetingsCount, userMeetingsCount) ||
                const DeepCollectionEquality()
                    .equals(other.userMeetingsCount, userMeetingsCount)) &&
            (identical(other.teamMeetingsDates, teamMeetingsDates) ||
                const DeepCollectionEquality()
                    .equals(other.teamMeetingsDates, teamMeetingsDates)) &&
            (identical(other.userMeetingsDates, userMeetingsDates) ||
                const DeepCollectionEquality()
                    .equals(other.userMeetingsDates, userMeetingsDates)));
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$ServerMeetingUpdatedParamsCopyWith<_ServerMeetingUpdatedParams>
      get copyWith => __$ServerMeetingUpdatedParamsCopyWithImpl<
          _ServerMeetingUpdatedParams>(this, _$identity);
