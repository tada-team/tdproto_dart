...
AddUserInWorkplaceByJidRequest _$AddUserInWorkplaceByJidRequestFromJson(Map<String, dynamic> json) {
...
class _$AddUserInWorkplaceByJidRequestTearOff {
  ...
  _AddUserInWorkplaceByJidRequest call({@JsonKey(name: 'contact_uuid') String? contactUuid}) {
...
/// @nodoc
const $AddUserInWorkplaceByJidRequest = _$AddUserInWorkplaceByJidRequestTearOff();
...
mixin _$AddUserInWorkplaceByJidRequest {
  ...
  @JsonKey(ignore: true)
  $AddUserInWorkplaceByJidRequestCopyWith<AddUserInWorkplaceByJidRequest> get copyWith =>
...
abstract class $AddUserInWorkplaceByJidRequestCopyWith<$Res> {
  factory $AddUserInWorkplaceByJidRequestCopyWith(
          AddUserInWorkplaceByJidRequest value, $Res Function(AddUserInWorkplaceByJidRequest) then) =
      _$AddUserInWorkplaceByJidRequestCopyWithImpl<$Res>;
  $Res call({@JsonKey(name: 'contact_uuid') String? contactUuid});
}

/// @nodoc
class _$AddUserInWorkplaceByJidRequestCopyWithImpl<$Res> implements $AddUserInWorkplaceByJidRequestCopyWith<$Res> {
...
/// @nodoc
abstract class _$AddUserInWorkplaceByJidRequestCopyWith<$Res> implements $AddUserInWorkplaceByJidRequestCopyWith<$Res> {
  factory _$AddUserInWorkplaceByJidRequestCopyWith(
          _AddUserInWorkplaceByJidRequest value, $Res Function(_AddUserInWorkplaceByJidRequest) then) =
...
/// @nodoc
class __$AddUserInWorkplaceByJidRequestCopyWithImpl<$Res> extends _$AddUserInWorkplaceByJidRequestCopyWithImpl<$Res>
    implements _$AddUserInWorkplaceByJidRequestCopyWith<$Res> {
  __$AddUserInWorkplaceByJidRequestCopyWithImpl(
      _AddUserInWorkplaceByJidRequest _value, $Res Function(_AddUserInWorkplaceByJidRequest) _then)
      : super(_value, (v) => _then(v as _AddUserInWorkplaceByJidRequest));

  @override
  _AddUserInWorkplaceByJidRequest get _value => super._value as _AddUserInWorkplaceByJidRequest;
...
/// @nodoc
@JsonSerializable()
class _$_AddUserInWorkplaceByJidRequest implements _AddUserInWorkplaceByJidRequest {
  const _$_AddUserInWorkplaceByJidRequest({@JsonKey(name: 'contact_uuid') this.contactUuid});

  factory _$_AddUserInWorkplaceByJidRequest.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  int get hashCode => runtimeType.hashCode ^ const DeepCollectionEquality().hash(contactUuid);

  @JsonKey(ignore: true)
  @override
  _$AddUserInWorkplaceByJidRequestCopyWith<_AddUserInWorkplaceByJidRequest> get copyWith =>
      __$AddUserInWorkplaceByJidRequestCopyWithImpl<_AddUserInWorkplaceByJidRequest>(this, _$identity);
...
abstract class _AddUserInWorkplaceByJidRequest implements AddUserInWorkplaceByJidRequest {
  const factory _AddUserInWorkplaceByJidRequest({@JsonKey(name: 'contact_uuid') String? contactUuid}) =
