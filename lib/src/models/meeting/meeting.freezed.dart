...
class _$_Meeting implements _Meeting {
  const _$_Meeting(
      ...
      @JsonKey(name: 'meeting_duration') this.meetingDuration});
    ...
    return identical(this, other) ||
        (other is _Meeting &&
            ...
            (identical(other.meetingMembers, meetingMembers) ||
                const DeepCollectionEquality().equals(other.meetingMembers, meetingMembers)) &&
...
abstract class _Meeting implements Meeting {
  const factory _Meeting(
      ...
      @JsonKey(name: 'meeting_start_at') @DateTimeConverter() DateTime? meetingStartAt,
      @JsonKey(name: 'meeting_freq') bool? meetingFreq,
      @JsonKey(name: 'meeting_duration') int? meetingDuration}) = _$_Meeting;
