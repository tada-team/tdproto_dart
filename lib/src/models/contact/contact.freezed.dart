  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _Contact &&
            ...
            (identical(other.meetingShortView, meetingShortView) || const DeepCollectionEquality().equals(other.meetingShortView, meetingShortView)) &&
            ...
            (identical(other.meetingMshortView, meetingMshortView) || const DeepCollectionEquality().equals(other.meetingMshortView, meetingMshortView)) &&
