...
mixin _$PushDevice {
  ...
  @JsonKey(ignore: true)
  $PushDeviceCopyWith<PushDevice> get copyWith => throw _privateConstructorUsedError;
}
...
abstract class _PushDevice implements PushDevice {
  const factory _PushDevice(
      ...
      @JsonKey(name: 'allowed_notifications') required bool allowedNotifications}) = _$_PushDevice;
  ...
  @override
  @JsonKey(ignore: true)
  _$PushDeviceCopyWith<_PushDevice> get copyWith => throw _privateConstructorUsedError;
}
