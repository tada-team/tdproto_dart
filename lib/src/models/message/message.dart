...
class Message with _$Message {
  const factory Message({
    ...
    @JsonKey(name: 'drafted') @NullableDateTimeConverter() DateTime? drafted,
    ...
    /// Importance flag.
    @JsonKey(name: 'important') bool? isImportant,

    /// ISODateTimeString of message modification or deletion. Readonly.
    @JsonKey(name: 'edited') @NullableDateTimeConverter() DateTime? edited,
    ...
    @JsonKey(name: 'editable_until') @NullableDateTimeConverter() DateTime? editableUntil,
