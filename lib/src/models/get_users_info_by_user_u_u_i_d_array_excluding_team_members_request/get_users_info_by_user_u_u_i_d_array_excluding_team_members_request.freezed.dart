...
GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestFromJson(
...
class _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestTearOff {
  ...
  GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest fromJson(Map<String, Object> json) {
    return GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest.fromJson(json);
  }
}
...
mixin _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest {
  ...
  $GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWith<
      GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWith<$Res> {
  factory $GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWith(
          ...
          $Res Function(GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest) then) =
...
class _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWithImpl<$Res>
    implements $GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWith<$Res> {
  _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWithImpl(this._value, this._then);

  final GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest _value;
  // ignore: unused_field
  final $Res Function(GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest) _then;
...
/// @nodoc
abstract class _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWith<$Res>
    implements $GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWith<$Res> {
  factory _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWith(
          ...
          $Res Function(_GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest) then) =
      __$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'user_uuid') List<String> userUuid,
      @JsonKey(name: 'team_uuid') String teamUuid,
...
/// @nodoc
class __$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWithImpl<$Res>
    extends _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWithImpl<$Res>
    implements _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWith<$Res> {
  __$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWithImpl(
      ...
      $Res Function(_GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest) _then)
      : super(_value, (v) => _then(v as _GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest));
...
class _$_GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest
  ...
  factory _$_GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest.fromJson(Map<String, dynamic> json) =>
  ...
  _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWith<
      ...
      get copyWith => __$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWithImpl<
          _GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestToJson(this);
  }
}
...
abstract class _GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest
  ...
  const factory _GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest(
      ...
      @JsonKey(name: 'team_uuid') required String teamUuid,
      @JsonKey(name: 'limit') int? limit,
      @JsonKey(name: 'offset') int? offset}) = _$_GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest;

  factory _GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest.fromJson(Map<String, dynamic> json) =
  ...
  @JsonKey(ignore: true)
  _$GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequestCopyWith<
      _GetUsersInfoByUserUUIDArrayExcludingTeamMembersRequest> get copyWith => throw _privateConstructorUsedError;
}
