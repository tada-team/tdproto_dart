...
class _$WorkplaceOptionsTearOff {
  ...
  _WorkplaceOptions call({@JsonKey(name: 'limit') int? limit, @JsonKey(name: 'offset') int? offset}) {
...
mixin _$WorkplaceOptions {
  ...
  @JsonKey(ignore: true)
  $WorkplaceOptionsCopyWith<WorkplaceOptions> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WorkplaceOptionsCopyWith<$Res> {
  factory $WorkplaceOptionsCopyWith(WorkplaceOptions value, $Res Function(WorkplaceOptions) then) =
      _$WorkplaceOptionsCopyWithImpl<$Res>;
  $Res call({@JsonKey(name: 'limit') int? limit, @JsonKey(name: 'offset') int? offset});
}

/// @nodoc
class _$WorkplaceOptionsCopyWithImpl<$Res> implements $WorkplaceOptionsCopyWith<$Res> {
...
/// @nodoc
abstract class _$WorkplaceOptionsCopyWith<$Res> implements $WorkplaceOptionsCopyWith<$Res> {
  factory _$WorkplaceOptionsCopyWith(_WorkplaceOptions value, $Res Function(_WorkplaceOptions) then) =
...
/// @nodoc
class __$WorkplaceOptionsCopyWithImpl<$Res> extends _$WorkplaceOptionsCopyWithImpl<$Res>
    implements _$WorkplaceOptionsCopyWith<$Res> {
  __$WorkplaceOptionsCopyWithImpl(_WorkplaceOptions _value, $Res Function(_WorkplaceOptions) _then)
...
class _$_WorkplaceOptions implements _WorkplaceOptions {
  const _$_WorkplaceOptions({@JsonKey(name: 'limit') this.limit, @JsonKey(name: 'offset') this.offset});

  factory _$_WorkplaceOptions.fromJson(Map<String, dynamic> json) => _$$_WorkplaceOptionsFromJson(json);
...
abstract class _WorkplaceOptions implements WorkplaceOptions {
  const factory _WorkplaceOptions({@JsonKey(name: 'limit') int? limit, @JsonKey(name: 'offset') int? offset}) =
      _$_WorkplaceOptions;

  factory _WorkplaceOptions.fromJson(Map<String, dynamic> json) = _$_WorkplaceOptions.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$WorkplaceOptionsCopyWith<_WorkplaceOptions> get copyWith => throw _privateConstructorUsedError;
}
