...
class _$AvatarColorsTearOff {
  ...
  _AvatarColors call({@JsonKey(name: 'task_default') required String taskDefault}) {
...
mixin _$AvatarColors {
  ...
  @JsonKey(ignore: true)
  $AvatarColorsCopyWith<AvatarColors> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AvatarColorsCopyWith<$Res> {
  factory $AvatarColorsCopyWith(AvatarColors value, $Res Function(AvatarColors) then) =
...
/// @nodoc
abstract class _$AvatarColorsCopyWith<$Res> implements $AvatarColorsCopyWith<$Res> {
  factory _$AvatarColorsCopyWith(_AvatarColors value, $Res Function(_AvatarColors) then) =
...
class __$AvatarColorsCopyWithImpl<$Res> extends _$AvatarColorsCopyWithImpl<$Res>
  ...
  __$AvatarColorsCopyWithImpl(_AvatarColors _value, $Res Function(_AvatarColors) _then)
...
class _$_AvatarColors implements _AvatarColors {
  const _$_AvatarColors({@JsonKey(name: 'task_default') required this.taskDefault});

  factory _$_AvatarColors.fromJson(Map<String, dynamic> json) => _$$_AvatarColorsFromJson(json);
    ...
    return identical(this, other) ||
        (other is _AvatarColors &&
            (identical(other.taskDefault, taskDefault) ||
                const DeepCollectionEquality().equals(other.taskDefault, taskDefault)));
  }

  @override
  int get hashCode => runtimeType.hashCode ^ const DeepCollectionEquality().hash(taskDefault);

  @JsonKey(ignore: true)
  @override
  _$AvatarColorsCopyWith<_AvatarColors> get copyWith => __$AvatarColorsCopyWithImpl<_AvatarColors>(this, _$identity);
...
abstract class _AvatarColors implements AvatarColors {
  const factory _AvatarColors({@JsonKey(name: 'task_default') required String taskDefault}) = _$_AvatarColors;

  factory _AvatarColors.fromJson(Map<String, dynamic> json) = _$_AvatarColors.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$AvatarColorsCopyWith<_AvatarColors> get copyWith => throw _privateConstructorUsedError;
}
