...
_$_TaskTab _$$_TaskTabFromJson(Map<String, dynamic> json) => _$_TaskTab(
      ...
      filters: (json['filters'] as List<dynamic>)
          .map((e) => TaskFilter.fromJson(e as Map<String, dynamic>))
          .toList(),
      sort: (json['sort'] as List<dynamic>)
          .map((e) => TaskSort.fromJson(e as Map<String, dynamic>))
          .toList(),
      unreadTasks: (json['unread_tasks'] as List<dynamic>)
          .map((e) => TaskCounters.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$$_TaskTabToJson(_$_TaskTab instance) =>
    <String, dynamic>{
      'key': instance.key,
