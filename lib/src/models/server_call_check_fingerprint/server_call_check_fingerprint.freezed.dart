...
class _$ServerCallCheckFingerprintTearOff {
  ...
  _ServerCallCheckFingerprint call(
      {@JsonKey(name: 'params')
          required ServerCallCheckFingerprintParams params,
      @JsonKey(name: 'event')
...
/// @nodoc
abstract class _$ServerCallCheckFingerprintCopyWith<$Res>
    implements $ServerCallCheckFingerprintCopyWith<$Res> {
  factory _$ServerCallCheckFingerprintCopyWith(
          _ServerCallCheckFingerprint value,
          $Res Function(_ServerCallCheckFingerprint) then) =
...
/// @nodoc
class __$ServerCallCheckFingerprintCopyWithImpl<$Res>
    extends _$ServerCallCheckFingerprintCopyWithImpl<$Res>
    implements _$ServerCallCheckFingerprintCopyWith<$Res> {
  __$ServerCallCheckFingerprintCopyWithImpl(_ServerCallCheckFingerprint _value,
      $Res Function(_ServerCallCheckFingerprint) _then)
      : super(_value, (v) => _then(v as _ServerCallCheckFingerprint));

  @override
  _ServerCallCheckFingerprint get _value =>
      super._value as _ServerCallCheckFingerprint;
...
class _$_ServerCallCheckFingerprint implements _ServerCallCheckFingerprint {
  ...
  @JsonKey(ignore: true)
  @override
  _$ServerCallCheckFingerprintCopyWith<_ServerCallCheckFingerprint>
      get copyWith => __$ServerCallCheckFingerprintCopyWithImpl<
          _ServerCallCheckFingerprint>(this, _$identity);
...
abstract class _ServerCallCheckFingerprint
  ...
  const factory _ServerCallCheckFingerprint(
      ...
      @JsonKey(name: 'event')
          required String name,
      @JsonKey(name: 'confirm_id')
          String? confirmId}) = _$_ServerCallCheckFingerprint;
