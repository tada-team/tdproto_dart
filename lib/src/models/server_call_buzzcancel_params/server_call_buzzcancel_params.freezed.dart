...
mixin _$ServerCallBuzzcancelParams {
  ...
  @JsonKey(ignore: true)
  $ServerCallBuzzcancelParamsCopyWith<ServerCallBuzzcancelParams> get copyWith => throw _privateConstructorUsedError;
}
...
abstract class _ServerCallBuzzcancelParams implements ServerCallBuzzcancelParams {
  const factory _ServerCallBuzzcancelParams(
      {@JsonKey(name: 'jid') required String jid,
      @JsonKey(name: 'team') required String team,
      @JsonKey(name: 'uid') required String uid}) = _$_ServerCallBuzzcancelParams;
  ...
  @override
  @JsonKey(ignore: true)
  _$ServerCallBuzzcancelParamsCopyWith<_ServerCallBuzzcancelParams> get copyWith => throw _privateConstructorUsedError;
}
