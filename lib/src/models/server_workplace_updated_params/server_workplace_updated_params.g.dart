...
_$_ServerWorkplaceUpdatedParams _$$_ServerWorkplaceUpdatedParamsFromJson(
...
Map<String, dynamic> _$$_ServerWorkplaceUpdatedParamsToJson(
        _$_ServerWorkplaceUpdatedParams instance) =>
    <String, dynamic>{
