...
_$_GetTeamOnPersonalAccountResponse
    _$$_GetTeamOnPersonalAccountResponseFromJson(Map<String, dynamic> json) =>
        _$_GetTeamOnPersonalAccountResponse(
...
Map<String, dynamic> _$$_GetTeamOnPersonalAccountResponseToJson(
        _$_GetTeamOnPersonalAccountResponse instance) =>
    <String, dynamic>{
