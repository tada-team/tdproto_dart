...
CounterpartyCreateRequest _$CounterpartyCreateRequestFromJson(
    Map<String, dynamic> json) {
  return _CounterpartyCreateRequest.fromJson(json);
}

/// @nodoc
class _$CounterpartyCreateRequestTearOff {
  const _$CounterpartyCreateRequestTearOff();

  _CounterpartyCreateRequest call(
    ...
    return _CounterpartyCreateRequest(
  ...
  CounterpartyCreateRequest fromJson(Map<String, Object> json) {
    return CounterpartyCreateRequest.fromJson(json);
  }
}

/// @nodoc
const $CounterpartyCreateRequest = _$CounterpartyCreateRequestTearOff();

/// @nodoc
mixin _$CounterpartyCreateRequest {
  /// .
  @JsonKey(name: 'personal_account_id')
  ...
  @JsonKey(ignore: true)
  $CounterpartyCreateRequestCopyWith<CounterpartyCreateRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CounterpartyCreateRequestCopyWith<$Res> {
  factory $CounterpartyCreateRequestCopyWith(CounterpartyCreateRequest value,
          $Res Function(CounterpartyCreateRequest) then) =
      _$CounterpartyCreateRequestCopyWithImpl<$Res>;
  $Res call(
      {@JsonKey(name: 'personal_account_id')
...
/// @nodoc
class _$CounterpartyCreateRequestCopyWithImpl<$Res>
    implements $CounterpartyCreateRequestCopyWith<$Res> {
  _$CounterpartyCreateRequestCopyWithImpl(this._value, this._then);

  final CounterpartyCreateRequest _value;
  // ignore: unused_field
  final $Res Function(CounterpartyCreateRequest) _then;
...
/// @nodoc
abstract class _$CounterpartyCreateRequestCopyWith<$Res>
    implements $CounterpartyCreateRequestCopyWith<$Res> {
  factory _$CounterpartyCreateRequestCopyWith(_CounterpartyCreateRequest value,
          $Res Function(_CounterpartyCreateRequest) then) =
      __$CounterpartyCreateRequestCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'personal_account_id')
          String personalAccountId,
...
/// @nodoc
class __$CounterpartyCreateRequestCopyWithImpl<$Res>
    extends _$CounterpartyCreateRequestCopyWithImpl<$Res>
    implements _$CounterpartyCreateRequestCopyWith<$Res> {
  __$CounterpartyCreateRequestCopyWithImpl(_CounterpartyCreateRequest _value,
      $Res Function(_CounterpartyCreateRequest) _then)
      : super(_value, (v) => _then(v as _CounterpartyCreateRequest));

  @override
  _CounterpartyCreateRequest get _value =>
      super._value as _CounterpartyCreateRequest;
  ...
  $Res call({
    ...
    return _then(_CounterpartyCreateRequest(
      personalAccountId: personalAccountId == freezed
          ? _value.personalAccountId
          : personalAccountId // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_CounterpartyCreateRequest implements _CounterpartyCreateRequest {
  const _$_CounterpartyCreateRequest(
      {@JsonKey(name: 'personal_account_id')
  ...
  factory _$_CounterpartyCreateRequest.fromJson(Map<String, dynamic> json) =>
      _$$_CounterpartyCreateRequestFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  _$CounterpartyCreateRequestCopyWith<_CounterpartyCreateRequest>
      get copyWith =>
          __$CounterpartyCreateRequestCopyWithImpl<_CounterpartyCreateRequest>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_CounterpartyCreateRequestToJson(this);
  }
}

abstract class _CounterpartyCreateRequest implements CounterpartyCreateRequest {
  const factory _CounterpartyCreateRequest(
      {@JsonKey(name: 'personal_account_id')
          required String personalAccountId,
      @JsonKey(name: 'electronic_document_management_id')
          String? electronicDocumentManagementId,
      ...
      @JsonKey(name: 'classifier_of_industrial_enterprises')
          String? classifierOfIndustrialEnterprises,
      @JsonKey(name: 'counterparty_type')
          required String counterpartyType}) = _$_CounterpartyCreateRequest;

  factory _CounterpartyCreateRequest.fromJson(Map<String, dynamic> json) =
      _$_CounterpartyCreateRequest.fromJson;
