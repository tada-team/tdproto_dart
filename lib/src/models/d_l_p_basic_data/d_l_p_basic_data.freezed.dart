...
mixin _$DLPBasicData {
  ...
  @JsonKey(ignore: true)
  $DLPBasicDataCopyWith<DLPBasicData> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DLPBasicDataCopyWith<$Res> {
  factory $DLPBasicDataCopyWith(DLPBasicData value, $Res Function(DLPBasicData) then) =
...
/// @nodoc
abstract class _$DLPBasicDataCopyWith<$Res> implements $DLPBasicDataCopyWith<$Res> {
  factory _$DLPBasicDataCopyWith(_DLPBasicData value, $Res Function(_DLPBasicData) then) =
...
class __$DLPBasicDataCopyWithImpl<$Res> extends _$DLPBasicDataCopyWithImpl<$Res>
  ...
  __$DLPBasicDataCopyWithImpl(_DLPBasicData _value, $Res Function(_DLPBasicData) _then)
...
class _$_DLPBasicData implements _DLPBasicData {
  ...
  factory _$_DLPBasicData.fromJson(Map<String, dynamic> json) => _$$_DLPBasicDataFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  _$DLPBasicDataCopyWith<_DLPBasicData> get copyWith => __$DLPBasicDataCopyWithImpl<_DLPBasicData>(this, _$identity);
...
abstract class _DLPBasicData implements DLPBasicData {
  const factory _DLPBasicData(
      ...
      @JsonKey(name: 'number') required int number,
      @JsonKey(name: 'name') required String name,
      @JsonKey(name: 'description') required String description}) = _$_DLPBasicData;

  factory _DLPBasicData.fromJson(Map<String, dynamic> json) = _$_DLPBasicData.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$DLPBasicDataCopyWith<_DLPBasicData> get copyWith => throw _privateConstructorUsedError;
}
