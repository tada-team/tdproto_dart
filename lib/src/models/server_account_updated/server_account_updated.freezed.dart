...
mixin _$ServerAccountUpdated {
  ...
  @JsonKey(ignore: true)
  $ServerAccountUpdatedCopyWith<ServerAccountUpdated> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ServerAccountUpdatedCopyWith<$Res> {
  factory $ServerAccountUpdatedCopyWith(ServerAccountUpdated value, $Res Function(ServerAccountUpdated) then) =
...
/// @nodoc
class _$ServerAccountUpdatedCopyWithImpl<$Res> implements $ServerAccountUpdatedCopyWith<$Res> {
...
/// @nodoc
abstract class _$ServerAccountUpdatedCopyWith<$Res> implements $ServerAccountUpdatedCopyWith<$Res> {
  factory _$ServerAccountUpdatedCopyWith(_ServerAccountUpdated value, $Res Function(_ServerAccountUpdated) then) =
...
/// @nodoc
class __$ServerAccountUpdatedCopyWithImpl<$Res> extends _$ServerAccountUpdatedCopyWithImpl<$Res>
    implements _$ServerAccountUpdatedCopyWith<$Res> {
  __$ServerAccountUpdatedCopyWithImpl(_ServerAccountUpdated _value, $Res Function(_ServerAccountUpdated) _then)
...
class _$_ServerAccountUpdated implements _ServerAccountUpdated {
  ...
  factory _$_ServerAccountUpdated.fromJson(Map<String, dynamic> json) => _$$_ServerAccountUpdatedFromJson(json);
  ...
  _$ServerAccountUpdatedCopyWith<_ServerAccountUpdated> get copyWith =>
      __$ServerAccountUpdatedCopyWithImpl<_ServerAccountUpdated>(this, _$identity);
...
abstract class _ServerAccountUpdated implements ServerAccountUpdated {
  const factory _ServerAccountUpdated(
      {@JsonKey(name: 'params') required ServerAccountUpdatedParams params,
      @JsonKey(name: 'event') required String name,
      @JsonKey(name: 'confirm_id') String? confirmId}) = _$_ServerAccountUpdated;

  factory _ServerAccountUpdated.fromJson(Map<String, dynamic> json) = _$_ServerAccountUpdated.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$ServerAccountUpdatedCopyWith<_ServerAccountUpdated> get copyWith => throw _privateConstructorUsedError;
}
