...
ActivateWorkplacesOnPersonalAccountResponse _$ActivateWorkplacesOnPersonalAccountResponseFromJson(
...
class _$ActivateWorkplacesOnPersonalAccountResponseTearOff {
  ...
  ActivateWorkplacesOnPersonalAccountResponse fromJson(Map<String, Object> json) {
    return ActivateWorkplacesOnPersonalAccountResponse.fromJson(json);
  }
}

/// @nodoc
const $ActivateWorkplacesOnPersonalAccountResponse = _$ActivateWorkplacesOnPersonalAccountResponseTearOff();
...
mixin _$ActivateWorkplacesOnPersonalAccountResponse {
  ...
  @JsonKey(ignore: true)
  $ActivateWorkplacesOnPersonalAccountResponseCopyWith<ActivateWorkplacesOnPersonalAccountResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ActivateWorkplacesOnPersonalAccountResponseCopyWith<$Res> {
  factory $ActivateWorkplacesOnPersonalAccountResponseCopyWith(ActivateWorkplacesOnPersonalAccountResponse value,
...
class _$ActivateWorkplacesOnPersonalAccountResponseCopyWithImpl<$Res>
  ...
  _$ActivateWorkplacesOnPersonalAccountResponseCopyWithImpl(this._value, this._then);
...
abstract class _$ActivateWorkplacesOnPersonalAccountResponseCopyWith<$Res>
    implements $ActivateWorkplacesOnPersonalAccountResponseCopyWith<$Res> {
  factory _$ActivateWorkplacesOnPersonalAccountResponseCopyWith(_ActivateWorkplacesOnPersonalAccountResponse value,
...
class __$ActivateWorkplacesOnPersonalAccountResponseCopyWithImpl<$Res>
  ...
  __$ActivateWorkplacesOnPersonalAccountResponseCopyWithImpl(_ActivateWorkplacesOnPersonalAccountResponse _value,
      $Res Function(_ActivateWorkplacesOnPersonalAccountResponse) _then)
      : super(_value, (v) => _then(v as _ActivateWorkplacesOnPersonalAccountResponse));
...
class _$_ActivateWorkplacesOnPersonalAccountResponse implements _ActivateWorkplacesOnPersonalAccountResponse {
  ...
  @JsonKey(ignore: true)
  @override
  _$ActivateWorkplacesOnPersonalAccountResponseCopyWith<_ActivateWorkplacesOnPersonalAccountResponse> get copyWith =>
      __$ActivateWorkplacesOnPersonalAccountResponseCopyWithImpl<_ActivateWorkplacesOnPersonalAccountResponse>(
          this, _$identity);
...
abstract class _ActivateWorkplacesOnPersonalAccountResponse implements ActivateWorkplacesOnPersonalAccountResponse {
  const factory _ActivateWorkplacesOnPersonalAccountResponse({@JsonKey(name: 'success') bool? success}) =
      _$_ActivateWorkplacesOnPersonalAccountResponse;

  factory _ActivateWorkplacesOnPersonalAccountResponse.fromJson(Map<String, dynamic> json) =
