...
_$_ServerCallScreenShareParams _$$_ServerCallScreenShareParamsFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$_ServerCallScreenShareParamsToJson(_$_ServerCallScreenShareParams instance) =>
    <String, dynamic>{
