...
_$_ParserGenerateChatsResponse _$$_ParserGenerateChatsResponseFromJson(
...
Map<String, dynamic> _$$_ParserGenerateChatsResponseToJson(
        _$_ParserGenerateChatsResponse instance) =>
    <String, dynamic>{
