...
_$_ServerUploadUpdatedParams _$$_ServerUploadUpdatedParamsFromJson(
...
Map<String, dynamic> _$$_ServerUploadUpdatedParamsToJson(
        _$_ServerUploadUpdatedParams instance) =>
    <String, dynamic>{
