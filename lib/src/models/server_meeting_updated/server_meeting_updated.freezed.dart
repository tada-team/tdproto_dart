...
mixin _$ServerMeetingUpdated {
  ...
  @JsonKey(ignore: true)
  $ServerMeetingUpdatedCopyWith<ServerMeetingUpdated> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ServerMeetingUpdatedCopyWith<$Res> {
  factory $ServerMeetingUpdatedCopyWith(ServerMeetingUpdated value, $Res Function(ServerMeetingUpdated) then) =
...
/// @nodoc
class _$ServerMeetingUpdatedCopyWithImpl<$Res> implements $ServerMeetingUpdatedCopyWith<$Res> {
...
/// @nodoc
abstract class _$ServerMeetingUpdatedCopyWith<$Res> implements $ServerMeetingUpdatedCopyWith<$Res> {
  factory _$ServerMeetingUpdatedCopyWith(_ServerMeetingUpdated value, $Res Function(_ServerMeetingUpdated) then) =
...
/// @nodoc
class __$ServerMeetingUpdatedCopyWithImpl<$Res> extends _$ServerMeetingUpdatedCopyWithImpl<$Res>
    implements _$ServerMeetingUpdatedCopyWith<$Res> {
  __$ServerMeetingUpdatedCopyWithImpl(_ServerMeetingUpdated _value, $Res Function(_ServerMeetingUpdated) _then)
...
class _$_ServerMeetingUpdated implements _ServerMeetingUpdated {
  ...
  factory _$_ServerMeetingUpdated.fromJson(Map<String, dynamic> json) => _$$_ServerMeetingUpdatedFromJson(json);
  ...
  _$ServerMeetingUpdatedCopyWith<_ServerMeetingUpdated> get copyWith =>
      __$ServerMeetingUpdatedCopyWithImpl<_ServerMeetingUpdated>(this, _$identity);
...
abstract class _ServerMeetingUpdated implements ServerMeetingUpdated {
  const factory _ServerMeetingUpdated(
      {@JsonKey(name: 'params') required ServerMeetingUpdatedParams params,
      @JsonKey(name: 'event') required String name,
      @JsonKey(name: 'confirm_id') String? confirmId}) = _$_ServerMeetingUpdated;

  factory _ServerMeetingUpdated.fromJson(Map<String, dynamic> json) = _$_ServerMeetingUpdated.fromJson;
  ...
  @override
  @JsonKey(ignore: true)
  _$ServerMeetingUpdatedCopyWith<_ServerMeetingUpdated> get copyWith => throw _privateConstructorUsedError;
}
